					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
					        ...
					        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
					          ...
					          <a class="dropdown-item active" href="homehand.php">Data Training Handball</a>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12" style="font-family: 'Viga', sans-serif;">
				<center>
						<h2 style="font-family: 'Viga', sans-serif;">Data Training Handball</h2>
				</center><br>
				...
				<table class="table" border="1">
					...
					<tbody>
						...
						<?php 
								...
								$ambil=$koneksi->query("SELECT * FROM data_trainhand"); 
						?>
						...
						<tr>
							...
							<td>	
								<a href="handball/ubahhan.php?id=<?php echo $pecah["id"] ?>"class="btn btn-warning" role="button">ubah</a>
								<a href="handball/hapushan.php?id=<?php echo $pecah["id"] ?>" onclick="javascript: return confirm('yakin?');" class="btn btn-danger" role="button">hapus</a>
							</td>		
						</tr>
						<?php $no++; ?>
						<?php } ?>
					...
					<a href="handball/inputhan.php" class="btn btn-primary">Tambah Data Training</a>
					<a href="handball/hapusallhan.php" class="btn btn-danger" onclick="javascript: return confirm('yakin?');">Hapus Semua Data Training</a>
