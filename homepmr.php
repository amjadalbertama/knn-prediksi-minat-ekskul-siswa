					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
					        ...
					        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
					          ...
					          <a class="dropdown-item active" href="homepmr.php">Data Training PMR</a>
					        </div>
					      </li>
							<li class="nav-item">
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12" style="font-family: 'Viga', sans-serif;">
				<center>
						<h2 style="font-family: 'Viga', sans-serif;">Data Training PMR</h2>
				</center><br><br>
				...
				<table class="table" border="1">
					...
					<tbody>
						...
						<?php 
								...
								$ambil=$koneksi->query("SELECT * FROM data_trainpmr"); 
						?>
						...
						<tr>
							...
							<td>	
								<a href="pmr/ubahpmr.php?id=<?php echo $pecah["id"] ?>"class="btn btn-warning" role="button">ubah</a>
								<a href="pmr/hapuspmr.php?id=<?php echo $pecah["id"] ?>" onclick="javascript: return confirm('yakin?');" class="btn btn-danger" role="button">hapus</a>
							</td>		
						</tr>
						<?php $no++; ?>
						<?php } ?>
					...
					<a href="pmr/inputpmr.php" class="btn btn-primary">Tambah Data Training</a>
					<a href="pmr/hapusallpmr.php" class="btn btn-danger" onclick="javascript: return confirm('yakin?');">Hapus Semua Data Training</a>
