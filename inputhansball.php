			...
			<div class="col-md-12" style="font-family: 'Viga', sans-serif;">
					...
					<h5><label for="">Pilih Data Training Ekstrakulikuler :</label>
					    <select class="custom-select col-md-3" name="pil_dtraining" id="pil_dtraining">
					        <option id="basket" value="basket" name="basket"><--Pilih--></option>
				...
				<?php
					...
					if (isset($_POST["add"]))
					{
						$koneksi->query("INSERT INTO data_trainhand(nilai_tes_masuk, nilai_psikotes, hasil_tes_kesehatan, hasil_tes_fisik, hasil_tes_wawancara, keterangan) VALUES ('$_POST[nilai_tes_masuk]', '$_POST[nilai_psikotes]', '$_POST[hasil_tes_kesehatan]', '$_POST[hasil_tes_fisik]', '$_POST[hasil_tes_wawancara]','$_POST[keterangan]')");
