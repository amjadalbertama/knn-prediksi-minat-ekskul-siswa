	...
	<div class="container" >
		<div class="row">
			<div class="col-md-12" style="font-family: 'Viga', sans-serif;">
					...
					<center>
							<h2>Input Data Training Basket</h2>
					</center><br><br>
				...
				<?php
					...
					if (isset($_POST["add"]))
					{
						...
						$koneksi->query("INSERT INTO data_training(nilai_tes_masuk, nilai_psikotes, hasil_tes_kesehatan, hasil_tes_fisik, hasil_tes_wawancara, keterangan) VALUES ('$_POST[nilai_tes_masuk]', '$_POST[nilai_psikotes]', '$_POST[hasil_tes_kesehatan]', '$_POST[hasil_tes_fisik]', '$_POST[hasil_tes_wawancara]','$_POST[keterangan]')");
